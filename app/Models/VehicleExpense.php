...
class VehicleExpense extends Model implements HasMedia
{
    ...
    public const EXPENSE_TYPE_RADIO = [
        ...
        'IVA' => 'IVA',
        'Limpeza' => 'Limpeza',
        'Limpeza Auto' => 'Limpeza Auto',
        'Mecánica' => 'Mecánica',
        'Penus' => 'Pneus',
        'Portagens' => 'Portagens',
        'Portagens Carlos' => 'Portagens Carlos',
        'Portagens Carolina' => 'Portagens Carolina',
        'Receita' => 'Receita',
        'Salários Motoristas' => 'Salários Motoristas',
        'Segurança Social' => 'Segurança Social',
        'Seguro' => 'Seguro',
        'Seguro Vida Banco' => 'Seguro Vida Banco',
        'Subscrição Tesla' => 'Subscrição Tesla',
        'Viatura Carolina' => 'Viatura Carolina',
        'Outros' => 'Outros',
    ];
