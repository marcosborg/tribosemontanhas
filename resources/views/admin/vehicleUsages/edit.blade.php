                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.vehicle-usages.update", [$vehicleUsage->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('start_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $vehicleUsage->start_date) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('end_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="end_date" id="end_date" value="{{ old('end_date', $vehicleUsage->end_date) }}">
