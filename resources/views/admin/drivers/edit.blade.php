                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.drivers.update", [$driver->id]) }}"
                        ...
                        <div class="form-group {{ $errors->has('emergency_contact') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="emergency_contact" id="emergency_contact"
                        ...
                        <div class="form-group {{ $errors->has('document_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="document_type" id="document_type">
                                ...
                                @foreach($document_types as $value => $label)
                                    <option value="{{ $value }}" {{ old('document_type', $driver->document_type) === $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
