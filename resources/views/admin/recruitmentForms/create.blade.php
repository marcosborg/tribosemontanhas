        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.recruitmentForm.title_singular') }}
                </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <input type="checkbox" name="contact_successfully"
                                                    id="contact_successfully" value="1" {{ old('contact_successfully',
                                                    0)==1 ? 'checked' : '' }}>
                                            ...
                                            <span class="help-block" role="alert">{{
                                                $errors->first('contact_successfully')
                                                }}</span>
                                            @endif
                                        ...
                                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                                            ...
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.recruitmentForm.fields.phone_helper')
                                                }}</span>
                                        </div>
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <input type="checkbox" name="scheduled_interview"
                                                    id="scheduled_interview" value="1" {{ old('scheduled_interview',
                                                    0)==1 ? 'checked' : '' }}>
                                            ...
                                            <span class="help-block" role="alert">{{
                                                $errors->first('scheduled_interview')
                                                }}</span>
                                            @endif
                                            <span class="help-block">{{
                                        ...
                                        <div class="form-group {{ $errors->has('appointment') ? 'has-error' : '' }}">
                                            ...
                                            <input class="form-control datetime" type="text" name="appointment"
                                                id="appointment" value="{{ old('appointment') }}">
                                        ...
                                        <div class="form-group {{ $errors->has('done') ? 'has-error' : '' }}">
                                            <div>
                                                ...
                                                <input type="checkbox" name="done" id="done" value="1" {{ old('done',
                                                    0)==1 ? 'checked' : '' }}>
                                            ...
                                            @endif
                                            <span class="help-block">{{
                                                trans('cruds.recruitmentForm.fields.done_helper')
                                                }}</span>
                                        </div>
                                    </div>
                                </div>
