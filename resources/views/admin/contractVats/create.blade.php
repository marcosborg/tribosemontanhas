                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contract-vats.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('rf') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="rf" id="rf" value="{{ old('rf', '') }}" step="0.01" required>
                            @if($errors->has('rf'))
                        ...
                        <div class="form-group {{ $errors->has('iva') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="iva" id="iva" value="{{ old('iva', '') }}" step="0.01" required>
                            @if($errors->has('iva'))
