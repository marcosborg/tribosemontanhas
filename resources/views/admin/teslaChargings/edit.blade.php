                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.tesla-chargings.update", [$teslaCharging->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('license') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="license" id="license" value="{{ old('license', $teslaCharging->license) }}">
                        ...
                        <div class="form-group {{ $errors->has('datetime') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="datetime" id="datetime" value="{{ old('datetime', $teslaCharging->datetime) }}">
